            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-success btn-sm" id="createNew"><i class="fas fa-plus"></i> Tambah Menu</button>
                    </div>
                </div>
                <div class="card-body">
    ...
    $(function () {
        ...
        $('body').on('click', '.editSlide', function () {
            ...
            $.get("{{ route('Menu.index') }}" +'/' + id +'/edit', function (data) {
                ...
                $('#link').val(data.link);
                $('#urut').val(data.urut);
                $('#gambar').html('<img src="file/menu/'+data.file+'" width="100%">');
            })
        });
